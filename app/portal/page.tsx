      ...
      {!isLoggedIn ? (
        ...
        <main className="py-20 max-w-md mx-auto px-4 relative z-10">
          <div className="bg-white p-8 rounded-3xl shadow-xl border border-slate-100 text-center relative overflow-hidden">
            ...
            <div className="w-20 h-20 bg-blue-50 text-[#0056B3] rounded-2xl flex items-center justify-center text-4xl mx-auto mb-6 shadow-inner border border-blue-100">
              🔐
            </div>
            <h1 className="text-2xl font-black text-slate-900 mb-2">بوابة المريض الرقمية</h1>
            <p className="text-slate-500 text-sm mb-8 leading-relaxed">
              أدخل رقم الملف الطبي أو رقم الجوال المسجل لدينا لعرض ملفك الصحي وسجل زياراتك لالمستشفى الأوربي الحديث.
            </p>
            ...
            <form onSubmit={handleLogin} className="space-y-5 text-right">
              <div>
                ...
                <input 
                  ...
                  className="w-full px-4 py-4 rounded-xl border border-slate-200 focus:ring-2 focus:ring-[#0056B3] focus:border-transparent outline-none text-center tracking-widest font-bold text-lg bg-slate-50 focus:bg-white transition"
                  value={patientId}
              ...
              <button 
                type="submit"
                className="w-full bg-[#0056B3] hover:bg-[#0a2342] text-white font-bold py-4 rounded-xl shadow-lg transition transform hover:-translate-y-1 flex justify-center items-center gap-2 text-lg"
              >
                دخول آمن إلى ملفي ↗
              </button>
            </form>
        ...
        <main className="py-10 max-w-6xl mx-auto px-4">
          ...
          <div className="bg-gradient-to-l from-[#0056B3] to-[#0a2342] text-white p-8 md:p-10 rounded-3xl shadow-xl mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <span className="bg-white/20 text-blue-100 text-xs font-bold px-4 py-1.5 rounded-full border border-white/30 backdrop-blur-sm">
            ...
            <div className="relative z-10 bg-white/10 p-5 rounded-2xl border border-white/20 text-center backdrop-blur-md w-full md:w-auto">
              <div className="text-sm text-blue-100 font-medium mb-1">الزيارة القادمة المؤكدة</div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-slate-100">
              <h3 className="text-xl font-black text-slate-900 mb-6 flex items-center gap-2 border-b border-slate-100 pb-4">
                <span className="text-[#0056B3]">📅</span> المواعيد القادمة
              </h3>
              <div className="space-y-4">
                <div className="bg-blue-50/50 p-5 rounded-2xl border border-blue-100 hover:shadow-md transition">
                  <div className="text-xs font-bold text-[#0056B3] mb-2 px-3 py-1 bg-white rounded-full inline-block shadow-sm">
                    مركز القلب والقسطرة
                  </div>
              ...
              <a href="/booking" className="mt-6 block text-center w-full bg-slate-50 hover:bg-slate-100 text-[#0056B3] font-bold py-3 rounded-xl border border-slate-200 transition">
                + حجز موعد جديد
              </a>
            </div>
            ...
            <div className="md:col-span-2 bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-slate-100">
              <h3 className="text-xl font-black text-slate-900 mb-6 flex items-center gap-2 border-b border-slate-100 pb-4">
                <span className="text-[#0056B3]">📋</span> سجل الزيارات والملف الطبي
              </h3>
